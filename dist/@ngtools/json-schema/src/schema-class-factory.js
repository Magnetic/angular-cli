...
var SchemaClassBase = (function () {
    function SchemaClassBase(schema, value) {
        ...
        var forward = fallbacks.length > 0
            ? (new (SchemaClassBase.bind.apply(SchemaClassBase, [void 0, schema, fallbacks.pop()].concat(fallbacks)))().$$schema())
            : null;
...
function SchemaClassFactory(schema) {
    var GeneratedSchemaClass = (function (_super) {
        ...
        function GeneratedSchemaClass(value) {
            ...
            return _super.apply(this, [schema, value].concat(fallbacks)) || this;
        }
...
//# sourceMappingURL=/Users/izumiwong-horiuchi/src/angular-cli/packages/@ngtools/json-schema/src/schema-class-factory.js.map