...
var MultiChange = (function () {
    function MultiChange() {
        ...
        var _this = this;
        this._changes = [];
        [].concat.apply([], changes).forEach(function (change) { return _this.appendChange(change); });
    }
...
//# sourceMappingURL=/Users/izumiwong-horiuchi/src/angular-cli/packages/@angular-cli/ast-tools/src/change.js.map