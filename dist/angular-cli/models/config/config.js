...
var CliConfig = (function () {
    function CliConfig(_configPath, schema, configJson, fallbacks) {
        ...
        this._config = new ((_a = (json_schema_1.SchemaClassFactory(schema))).bind.apply(_a, [void 0, configJson].concat(fallbacks)))();
        var _a;
    }
...
//# sourceMappingURL=/Users/izumiwong-horiuchi/src/angular-cli/packages/angular-cli/models/config/config.js.map